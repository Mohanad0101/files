...
- `images/` — при необходимости добавьте сюда скриншоты или экспорт схем из презентации (см. [images/README.md](images/README.md)).

### Иллюстрации

Иллюстрации не обязательны для сдачи: при желании можно сохранить диаграммы из презентации курса или построить свои в ноутбуке.
